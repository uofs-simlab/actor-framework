...
public:
    ...
    virtual void reclaim([[maybe_unused]] int value, 
                         [[maybe_unused]] int memory_returned, 
                         [[maybe_unused]] int runtime, 
                         [[maybe_unused]] int dependency) {
    ...
    virtual void handle_load_balance_request(
   ...
   virtual void receive_work(
        [[maybe_unused]] std::vector<kernel_graph> work_graphs) {
