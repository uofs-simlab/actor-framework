...
CAF_ADD_TYPE_ID(cuda_control, caf::instrusive_ptr<caf::cuda::memory_transfer_token>)
...
CAF_ALLOW_UNSAFE_MESSAGE_TYPE(caf::instrusive_ptr<caf::cuda::memory_transfer_token>)
