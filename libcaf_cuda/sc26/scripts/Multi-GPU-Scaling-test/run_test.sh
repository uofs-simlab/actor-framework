...
BASE_DIR=/student/nqr159/data/scheduler-test/hetergenous-workloads/gpu_scaling_tests
BIN=/student/nqr159/gpufarm5/actor-framework/libcaf_cuda/tests/benchmark-tests/scheduler-benchmark-tests/mmul-randonom-batch-benchmark/build/test
